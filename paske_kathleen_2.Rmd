...
library(mosaic)
```
The following shows the number of cancelled flights by destination and airline leaving Austin. In otherwords, which locations not to fly to from Austin given the high number of cancellations, and which airlines are the least reliable for a given destination. 
```{r}
